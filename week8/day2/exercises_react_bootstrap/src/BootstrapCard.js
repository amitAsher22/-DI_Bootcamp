...
<div className="card m-5" style={{width: '30rem'}}>
  <img className="card-img-top" src={props.people[0].imageUrl} alt="Card  cap" />
  <div className="card-body">
    <h5 className="card-title">{props.people[0].title}</h5>
    <p className="card-text">{props.people[0].description}</p>
    <a href="https://en.wikipedia.org/wiki/Bob_Dylan" className="btn btn-primary">{props.people[0].buttonLabel}</a>
  </div>
</div>
