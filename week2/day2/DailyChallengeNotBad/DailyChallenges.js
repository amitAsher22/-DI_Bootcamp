...
let badWord = Number(sentence.search("bad"));
let badnot = Number(sentence.search("not"));
...
if(badWord > badnot){
    ...
    // console.log("the word “bad” does not come before “not” or the words are not in the sentence,");
}
