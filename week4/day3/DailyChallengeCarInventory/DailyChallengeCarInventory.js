...
//   return carInventory.filter(element => element.car_make === "Honda");
   
// }

// let found = inventory.find(e => {
//     let everySentence =  e.car_make === 'Honda' ? `This is a ${e.car_make} ${e.car_model} from ${e.car_year}` : null
//         console.log(everySentence);
//     });
